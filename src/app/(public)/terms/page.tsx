      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-16">
          ...
          <p className="text-gray-700 mb-8">
            These Terms of Service ("Terms") govern your use of OpenEvents and
            the purchase of tickets for events organized by Eyevinn Technology
            AB. By purchasing a ticket or using the platform, you agree to these
            Terms.
          </p>
          ...
          <section className="mb-10">
            ...
            <p className="text-gray-700">
              OpenEvents is a ticketing platform operated by Eyevinn Technology
              AB for events such as Streaming Tech 2026.
            </p>
          </section>
          ...
          <section className="mb-10">
            ...
            <p className="text-gray-700 mb-4">
              Eyevinn Technology reserves the right to:
            </p>
            <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4">
          ...
          <section className="mb-10">
            ...
            <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4">
              <li>Eyevinn is not liable for indirect damages</li>
              <li>Liability is limited to the ticket price paid</li>
              <li>Nothing limits liability where prohibited by Swedish law</li>
            </ul>
          </section>
          ...
          <section className="mb-10">
            ...
            <p className="text-gray-700 mb-4">
              Eyevinn is not liable for failure to perform due to circumstances
          ...
          <section className="mb-10">
            ...
            <p className="text-gray-700 mb-4">
              ...
              and media, is owned by Eyevinn Technology unless otherwise stated.
            </p>
            <p className="text-gray-700">
          ...
          <section className="mb-10">
            ...
            <p className="text-gray-700">
              For questions regarding these Terms, contact: [info@eyevinn.se]
            </p>
          </section>
        </div>
